...
public class PortableDeviceValuesImplWin32 implements COMReferenceable
{
	...
	public PortableDeviceValuesImplWin32() throws COMException
	{
		pDeviceValues = COM.CoCreateInstance(WPDImplWin32.CLSID_PortableDeviceValues, 0, COM.CLSCTX_INPROC_SERVER, WPDImplWin32.IID_IPortableDeviceValues);
	}
	...
	public native void setPortableDeviceValuesCollectionValue(PropertyKey key, PortableDevicePropVariantCollectionImplWin32 value) throws COMException;

	public native PortableDevicePropVariantCollectionImplWin32 getPortableDeviceValuesCollectionValue(PropertyKey key) throws COMException;
