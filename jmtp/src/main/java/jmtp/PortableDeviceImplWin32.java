 ...
 */
public class PortableDeviceImplWin32 implements PortableDevice
{
	...
	PortableDeviceImplWin32(COMReference pDeviceManager, String deviceID)
	{
		...
		try
		{
			pDevice = COM.CoCreateInstance(WPDImplWin32.CLSID_PortableDevice, 0, COM.CLSCTX_INPROC_SERVER, WPDImplWin32.IID_IPortableDevice);
		}
	...
	public PortableDeviceObject[] getPortableDeviceObjectsFromPersistentUniqueIDs(String[] persistentUniqueIDs)
	{
		...
		try
		{
			...
			{
				result[i] = WPDImplWin32.convertToPortableDeviceObject((String) objectIDCollection.getAt(i).getValue(), content, properties);
			}
	...
	public boolean equals(Object obj)
	{
		...
		if (getClass() != obj.getClass())
			return false;
		PortableDeviceImplWin32 other = (PortableDeviceImplWin32) obj;
